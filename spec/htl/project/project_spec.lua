...
describe("in_project", function()
    ...
    it("in project subdir", function()
        get_project()
        local path = test_project_dir:join("test")
        Path.mkdir(path)
...
describe("root_from_path", function()
    it("+", function()
        get_project()
        assert.are.same(tostring(test_project_dir), Project.root_from_path(test_project_dir))
    end)

    it("+: subfile", function()
        get_project()
        assert.are.same(tostring(test_project_dir), Project.root_from_path(test_project_file))
    end)
...
describe("root", function()
    it("gets", function()
        get_project()
        assert.are.same(tostring(test_project_dir), project.root)
    end)
end)
