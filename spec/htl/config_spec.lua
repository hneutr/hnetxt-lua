...
describe("it", function()
    it("a", function()
        ...
        -- print(Conf.keys())
        -- print(Conf.snippets.keys())
        -- os.exit()
        
        -- -- print(require("inspect")(Conf.snippets:keys()))
        -- print(Conf.snippets:keys())
        -- -- print(require("inspect")(Conf.snippets.word))
        -- print(Conf.snippets.word)
        -- -- print(require("inspect")(_G.test))
    end)
end)
