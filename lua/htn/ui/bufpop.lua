...
function M.setup(opts)
	...
	km.set("n", defaut_opts.keymap.open_bufferlist, list_buffers, {desc = "Open BufferList"})

    api.nvim_create_user_command("BufferList", list_buffers, {desc = "Open BufferList"})
